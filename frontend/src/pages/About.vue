  ...
  <div id="app" class="container">
    <div class="row">
      <div class="col d-flex">
        <card title="About" sub-title="Get to know the ShiwaNetwork Wallet">
          <p>
            Thank you for using the ShiwaNetwork Desktop Wallet!
            <br />
            <br />The ShiwaNetwork Desktop Wallet was built by our community member
            <b>@armedvito</b> and is an application overlay that integrates with the wallet binary produced by
            the ShiwaNetwork Engineering team. This means that all major aspects around the security of the wallet is managed by the team, as well as yourself - since you will be responsible for handling the wallet backup and private key (see
            the
    ...
    <div class="row">
      <div class="col d-flex">
        <card title="Frequently Asked Questions">
          <p>
            <b>I thought $SHI was free to transact, why do I need to enter a fee?</b>
            <br />$SHI transactions are indeed free. The fee is intended for companies with higher data throughput demands.
            <br />
            <br />
