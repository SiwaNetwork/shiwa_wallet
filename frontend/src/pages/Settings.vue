    ...
    <div class="row">
      <div class="col-12">
        <card
          ...
          sub-title="Configure the Shiwa Wallet to your personal preferences"
        ></card>
      </div>
    </div>
    <div class="row">
      ...
      <!-- <div class="col-md-6 d-flex">
        <card
          ...
          sub-title="Update Shiwa Wallet to the latest stable build"
        >
      ...
      <div class="col-md-6 d-flex">
        <card
          ...
          sub-title="Customize your Shiwa Wallet display settings"
        >
          <div class="container">
