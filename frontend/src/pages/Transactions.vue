<template>
  <div id="app" class="container">
    <div class="row">
      <div class="col">
        <card title="Transactions" subTitle="Submit a $SHI Transaction">
              ...
              <div class="col-md-4">
                <div class="input-group" style="margin-bottom: 0;">
                  ...
                  <div class="input-group-append">
                    <button type="button" @click="setMaxSHIs()" class="btn">Max.</button>
                  </div>
                </div>
                  ...
                  <slot :row="tx">
                    ...
                    <td class="columnB">
                      <p class="description" style="font-size: 0.9375rem;">
                        <b>{{(tx.amount / 1e8).toFixed(8).replace(/\.?0+$/,"")}}</b> SHI
                      </p>
                    </td>
                    <td class="columnC">
...
const verifyPrefix = value =>
  value.substring(0, 3) === "SHI" || value.substring(0, 3) === "";
