  ...
  onIdle() {
    ...
    if (this.isLoggedIn) {
      swalPopup.fire({
        ...
        html: "To keep your Shiwa wallet safe from unauthorised access it will automatically logout in <b>10</b> seconds",
    ...
    window.wails.Events.On("new_release", m => {
      ...
      this.$notify({
        ...
        onClick: () => {
          ...
          swalPopup.fire({
            title: "Update Shiwa Wallet",
            html: "Do you want to update your Shiwa Wallet? Selecting update will download the latest build and apply the update. <br><br> <b>The application will restart once update is complete. </b>",
            ...
            if (result.value) {
              ...
              self.overlay = true;
              window.backend.WalletApplication.UpdateShiwa()
